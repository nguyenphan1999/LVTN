...
def detected(img,type):
    ...
    if type==1:
        img=img[320:400,60:300]
        fore = cv2.Canny(img,10,30)
    elif type==0:
    ...
    try:
        ...
        if type==0:
            ...
            if (120>(x+w/2)>100) and area>8000 :
                return 0
            else:
                return 1
    except:
...
def shape():
    ...
    model = Yolov4(weights_dir='yolov4-custom_last_version6.weights',
